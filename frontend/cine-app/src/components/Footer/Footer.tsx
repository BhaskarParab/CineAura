          ...
          <div className="flex gap-4 text-xl opacity-80">
            ...
            >
              <img
                src={linkedin}
                alt="linkedin Logo"
                className="w-9 h-9 opacity-90 hover:opacity-100 -mt-0.5 cursor-pointer"
              />
            </a>
            <a href="https://github.com/BhaskarParab" target="_blank">
              {isDark === "dark" ? (
                <svg
                  ...
                  stroke="black"
                  fill="white"
                  className="octicon opacity-90 hover:opacity-100 -mt-0.5 octicon-mark-github v-align-middle"
                >
